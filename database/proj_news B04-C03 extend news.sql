...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2022 at 04:08 PM
...
(1, 'Trang chủ123', 'active', 1, '/', 'link', 'current'),
(3, 'Blog', 'active', 3, NULL, 'category_article', 'current'),
(10, 'Sản phẩm', 'active', 2, NULL, 'category_product', 'new_tab'),
