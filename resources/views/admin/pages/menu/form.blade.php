...
@php
    ...
    $typeMenuValue      = array_combine(array_keys(config('zvn.template.type_menu')), array_column(config('zvn.template.type_menu'), 'name'));
    $typeOpenValue      = array_combine(array_keys(config('zvn.template.type_open')), array_column(config('zvn.template.type_open'), 'name'));
    ...
    $elements = [
        ...
        [
            'label'   => Form::label('type_menu', 'Type_menu', $formLabelAttr),
            'element' => Form::select('type_menu', $typeMenuValue, @$item['type_menu'], $formInputAttr)
        ],
        [
            'label'   => Form::label('type_open', 'Type_open', $formLabelAttr),
